...
| `@phonenumber(PhoneType.MOBILE)`    | 移动电话号码      | `"134-5678-9012"`              |
| `@phonenumber(PhoneType.LANDLINE)`  | 固定电话号码      | `"010-1234-5678"`              |
| `@phonenumber(PhoneType.TOLL_FREE)` | 免费电话号码      | `"800-123-4567"`               |
| `@phonenumber(PhoneType.PREMIUM)`   | 付费电话号码      | `"900-123-4567"`               |
