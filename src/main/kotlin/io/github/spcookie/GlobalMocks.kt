...
import io.github.spcookie.GlobalMockConf.bg
import io.github.spcookie.GlobalMockConf.g
import io.github.spcookie.GlobalMockConf.stg
import java.lang.reflect.Type
import kotlin.reflect.KClass
import kotlin.reflect.KType
import kotlin.reflect.full.createInstance

sealed class TopMock(
    /**
     * 用于生成随机值的Random工具实例
     *
     * 提供对各种随机数据生成方法的访问，包括
    ...
    fun <T : Any> stg(type: KType): T {
        return beanMockBridge.mockType(type)
    }
...
) : TopMock(random, typeAdapter, containerAdapter) {
