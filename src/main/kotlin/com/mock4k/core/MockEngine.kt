package com.mock4k.core

import com.mock4k.random.MockRandom
import com.mock4k.rule.RuleParser
import com.mock4k.rule.RuleExecutor
import com.mock4k.placeholder.PlaceholderResolver
...
class MockEngine(private val random: MockRandom = MockRandom) {
    ...
    private fun generateFromMap(template: Map<String, Any>): Map<String, Any> {
        ...
        template.forEach { (key, value) ->
            ...
            val generatedValue = when {
                parsedRule.hasRule() -> {
                    ruleExecutor.execute(parsedRule, value, this)
                }
                else -> generate(value)
            }
